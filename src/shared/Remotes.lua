...
-- This script should be placed in ReplicatedStorage/DreamWorlds/Remotes
-- It creates all necessary RemoteEvents and RemoteFunctions
...
function Remotes:WaitForRemote(name)
    -- Used by scripts waiting for remotes to be created
